            ...
            child: const Column(
              children: [
                ...
                ListTile(
                  ...
                  subtitle: GetCampo(campo: 'dataNascimento'),
                ),
                ListTile(
                  ...
                  subtitle: GetCampo(campo: 'nomePai'),
                ),
                ListTile(
                  ...
                  subtitle: GetCampo(campo: 'nomeMae'),
                ),
                ListTile(
                  title: Text(
                    'PRIMEIRA OPÇÃO',
                  ...
                  subtitle: GetCampo(campo: 'curso1'),
                ...
                ListTile(
                  ...
                  subtitle: GetCampo(campo: 'curso2'),
                  trailing: Icon(Icons.school, color: Colors.white70),
                )
              ],
            ),
...
class GetCampo extends StatelessWidget {
  final String campo;

  const GetCampo({super.key, required this.campo});
